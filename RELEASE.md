...
This guide describes the standard process for publishing a new django-social-auth-rest release to PyPI.
...
[https://pypi.org/project/django-social-auth-rest/](https://pypi.org/project/django-social-auth-rest/)
...
```bash
pip install --pre django-social-auth-rest
```
