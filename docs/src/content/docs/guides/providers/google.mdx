...
This is the only credential Google needs. As covered in <a href={`${base}/guides/getting-started/`}>Getting Started</a>, the provider switches on automatically once this is set.
